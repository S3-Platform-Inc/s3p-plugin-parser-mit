...
[![Sync plugin to S3](https://github.com/S3-Platform-Inc/s3p-plugin-parser-mit/actions/workflows/sync-release.yml/badge.svg)](https://github.com/S3-Platform-Inc/s3p-plugin-parser-mit/actions/workflows/sync-release.yml)
